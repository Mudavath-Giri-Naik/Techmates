...
class _HeaderSectionState extends State<HeaderSection>
        ...
        children: [
          ...
          Row(
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (widget.college?.isNotEmpty == true)
                      Text(widget.college!,
                          style: TextStyle(
                              color: _text2(context), fontSize: 9),
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis),
                  ],
                ),
              ...
              AnimatedBuilder(
                animation: _anim,
                builder: (_, __) => _scoreRing(sb.total, _anim.value, context),
              ),
            ],
          ),
          ...
          Row(children: [
            Expanded(
                child: _bar('Depth', sb.depth, const Color(0xFF00D4FF), context)),
            const SizedBox(width: 10),
            Expanded(
                child:
                    _bar('Craft', sb.consistency, const Color(0xFF8B5CF6), context)),
          ]),
          const SizedBox(height: 6),
          Row(children: [
            Expanded(
                child:
                    _bar('Deploy', sb.breadth, const Color(0xFF22C55E), context)),
            const SizedBox(width: 10),
            Expanded(
                child:
                    _bar('Consist', sb.activity, const Color(0xFFF59E0B), context)),
          ]),
        ],
      ),
    );
  ...
  Widget _chip(String text, Color? color, BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(4),
        border: Border.all(
            color: color?.withValues(alpha: 0.3) ?? _borderCol(context)),
      ),
      child: Text(text,
          style: TextStyle(
              color: color ?? _text2(context),
              fontSize: 9,
  ...
  Widget _scoreRing(int score, double progress, BuildContext context) {
    ...
    return Column(
      children: [
        SizedBox(
          ...
          height: 56,
          child: CustomPaint(
            painter: _RingPainter(fraction, Theme.of(context).colorScheme.outlineVariant),
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text('/1000',
                      style: TextStyle(
                          color: _text2(context), fontSize: 7, fontFamily: 'monospace')),
                ],
              ),
            ),
          ),
  ...
  Widget _bar(String label, int value, Color color, BuildContext context) {
